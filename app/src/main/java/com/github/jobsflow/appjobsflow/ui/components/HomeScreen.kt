  ...
  AppScaffold(
    ...
    if (showSearchQueryHelpDialog) {
      AlertDialog(
        ...
        text = {
          Text("Это поле необязательное и служит для более точного подбора подходящих вакансий. Если оно пустое, будут рассмотрены все вакансии, соответствующие выбранному резюме.")
        },
        confirmButton = {
