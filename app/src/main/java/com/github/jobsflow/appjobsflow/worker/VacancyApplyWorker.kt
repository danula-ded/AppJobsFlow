    ...
    private suspend fun applySimilarVacancies() {
        for (page in 0 until 20) {
            ...
            try {
                ...
                // в doWork, если это общая ошибка. Если это специфичная API-ошибка здесь,
            ...
            for (vacancy in items) {
                ...
                // --- Случайный просмотр вакансии и аккаунта работодателя с задержками ---
                ...
                try {
                    ...
                    return
                } catch (e: ApiException) { // Ошибка API при отклике
